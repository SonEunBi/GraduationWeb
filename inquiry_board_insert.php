...
<?php
   ...
   $sql = "insert into inquiryboard (id, name, subject, repairtype, partname, cartype, location, price, partnum, content, regist_day, hit,  file_name, file_type, file_copied) ";
